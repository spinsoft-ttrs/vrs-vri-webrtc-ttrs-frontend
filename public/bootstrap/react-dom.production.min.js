...
(function (la, m) {
  ...
  function gh(a) {
    ...
    return function (a, d, f, h) {
      ...
      if ("string" === typeof f || "number" === typeof f)
        return (
          (f = "" + f),
          null !== d && 6 === d.tag ? (c(a, d.sibling), (d = e(d, f, h)), (d.return = a), (a = d)) : (c(a, d), (d = xe(f, a.mode, h)), (d.return = a), (a = d)),
          g(a)
        );
  ...
  function Bh(a, b, c, d, e) {
    ...
    rb(b, e);
    if (null === b.stateNode) null !== a && ((a.alternate = null), (b.alternate = null), (b.effectTag |= 2)), dh(b, c, d, e), we(b, c, d, e), (d = !0);
    else if (null === a) {
      var g = b.stateNode,
        h = b.memoizedProps;
      g.props = h;
          ...
          do {
            switch (k.tag) {
              ...
              case 1:
                ...
                if (
                  0 === (k.effectTag & 64) &&
                  ("function" === typeof F.getDerivedStateFromError || (null !== r && "function" === typeof r.componentDidCatch && (null === La || !La.has(r))))
                ) {
                  k.effectTag |= 4096;
                  k.expirationTime = b;
                  var u = Ph(k, g, b);
          ...
          "selectionStart" in r
            ...
            : ((w = ((u = r.ownerDocument || document) && u.defaultView) || window),
              w.getSelection &&
                ...
                l &&
                  p &&
                  (1 !== w.rangeCount || w.anchorNode !== l.node || w.anchorOffset !== l.offset || w.focusNode !== p.node || w.focusOffset !== p.offset) &&
                  ((u = u.createRange()),
  ...
  function Jj(a, b, c) {
    ...
    S === a && R === c
      ...
      : Rh(a, c) &&
        ((b = a.lastPingedTime),
        (0 !== b && b < c) || ((a.lastPingedTime = c), a.finishedExpirationTime === c && ((a.finishedExpirationTime = 0), (a.finishedWork = null)), T(a)));
  }
  function Cj(a, b) {
    var c = a.stateNode;
    null !== c && c.delete(b);
  ...
  Aa &&
    ...
    "AnimationEvent" in window || (delete ib.animationend.animation, delete ib.animationiteration.animation, delete ib.animationstart.animation),
  ...
  var wk = {
    ...
    xk = {
      ...
      extractEvents: function (a, b, c, d, e) {
        ...
        if (g) {
          if (((g = b), (b = (b = c.relatedTarget || c.toElement) ? Jb(b) : null), null !== b && ((f = Na(b)), b !== f || (5 !== b.tag && 6 !== b.tag))))
            b = null;
        } else g = null;
        if (g === b) return null;
  ...
  jf.injectEventPluginsByName({ SimpleEventPlugin: vi, EnterLeaveEventPlugin: xk, ChangeEventPlugin: wk, SelectEventPlugin: zk, BeforeInputEventPlugin: vk });
  new Set();
  var ne = [],
    nb = -1,
    Da = {},
