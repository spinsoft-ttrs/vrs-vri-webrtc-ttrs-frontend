                    ...
                    <div className="shortcuts setting" style={{ width: "100%" }}>
                        ...
                        <div className="setting_form">
                            <ul>
                                ...
                                <li>
                                    Turn URL :{" "}
                                    <input className="input-setting" type="text" placeholder="turn url" onChange={handleChangeTurnURL} value={turnURL} />
                                    Turn Username :{" "}
                                    <input
                                        className="input-setting"
                                        type="text"
                                        placeholder="turn username"
                                        onChange={handleChangeTurnUsername}
                                        value={turnUsername}
                                    />
                                    Turn Credential :{" "}
                                    <input
                                        ...
                                        onChange={handleChangeTurnCredential}
