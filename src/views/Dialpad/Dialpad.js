            ...
            <div className="show">
                <div className="shortcuts-phonekeypad">
                            ...
                            <div className={`shortcuts ${mobileControl ? "hide" : ""}`}>
                                <div className="d-block" style={{ marginLeft: "-16px", marginRight: "-16px" }}>
                                    <div className="vrs_map">
                                        <div className="txt-vrs">{locationName}</div>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-lg-12 shorcut-custom">
                                        <div className="shortcuts-box">
                                            <a href="#!" className="shorcut-link" onClick={(event) => handleStaticCall("vrs")}>
                                            ...
                                            <div className="modal fade" id="ShowVdo7" tabIndex="-1" role="dialog" aria-labelledby="Title" aria-hidden="true">
                                    ...
                                    <div className="col-lg-12 shorcut-custom">
                                        <div className="shortcuts-box">
                                            <a href="#!" className="shorcut-link" onClick={(event) => handleStaticCall("vri")}>
                                                <div className="img-icon">
                                                    <img src={require("./img/vri.png").default} alt="vri" />
                                                </div>
                                                <div className="txt-desc">
                                                    <div className="head">TTRS VRI</div>
                                                </div>
                                            </a>
                                    ...
                                    <div className="col-lg-12 shorcut-logout">
                                        <div className="shortcuts-box" style={{ backgroundColor: "#ffd7d7" }}>
                                            <a href="#!" className="shorcut-link" onClick={(event) => handleStaticCall("logout")}>
                                                <div className="img-icon">
                                            ...
                                            <div className="modal fade" id="ShowVdo8" tabIndex="-1" role="dialog" aria-labelledby="Title" aria-hidden="true">
                                                <div className="modal-dialog modal-dialog-centered" role="document">
                                                    <div className="modal-content modal_exp_vdo">
                                                        <button type="button" className="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                    ...
                                    <div className={`col-md-12 hide`} onClick={(event) => handleLogout()}>
                                        <div className="shortcuts-box">
                                            <a href="#!" className="d-flex align-items-center justify-content-center" onClick={(event) => handleLogout()}>
                                                <div className="img-icon">
                                                    <FiLogOut size={33} />
                                                </div>
                                                <div className="txt-desc">
                    ...
                    <div className="shortcuts-menu">
                        <div
                            className={`btn_shortcuts-menu ${mobileControl ? "" : "active"}`}
                            style={{ width: "100%" }}
                            onClick={(event) => handleShortCut("Shortcut")}
                        >
                            <div style={{ lineHeight: "1" }}>
                                <img className="bar-img-menu" src={require("./img/ic_speed_dial.png").default} alt="vri" />
                                <a className="shortcut-menu-icon" href="#!">
                                    เมนู
                                </a>
                            </div>
                        </div>
