        ...
        <div className="log-in">
          <div className="login_box">
            <div className="log-in_box">
              <div className="logo">
                <img
                  className="logo-hand2-blue"
                  src={require("./img/logo-hand2-blue.png").default}
                  style={{ width: `calc(100% + 38px)`, marginLeft: "-14px" }}
                  alt=""
                />
              </div>
              <br />
              <h2 className="entry-title" style={{ color: "blue" }}>
                บริการถ่ายทอดการสื่อสารแบบสนทนาวิดีโอบนอินเทอร์เน็ต
              </h2>
              <div className="ipt_log-in">
                ...
                <button className="btn btn-login" type="submit" onClick={(event) => handleLogin()}>
                  เข้าสู่ระบบ
                </button>
              </div>
            </div>
