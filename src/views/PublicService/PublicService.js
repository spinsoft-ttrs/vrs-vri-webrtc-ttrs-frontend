...
const PublicService = () => {
      ...
      fetch(`${process.env.REACT_APP_URL_MAIN_API}/extension/public`, {
        ...
        .then((data) => {
          if (data.status === "OK") {
            ...
            dispatch(setRegisterData("callNumber", 14130));
    ...
    if (!isIpadOS()) {
      if (browser.os === "Android OS") {
        ...
        window.location.href =
          "https://play.google.com/store/apps/details?id=ttrs.vrs&hl=en_GB&gl=th";
      } else if (browser.os === "iOS") {
        alert("อุปกรณ์ไม่รองรับการใช้งาน");
        window.location.href =
          "https://apps.apple.com/th/app/ttrs-video/id1467360876?l=th";
      }
    }
      ...
      navigator.geolocation.getCurrentPosition(
        (position) => {
          fetch(
            ...
            .then((data) => {
              setLocationName(
                `${data.district} ${data.subdistrict} ${data.province}`
              );
  ...
  return (
    <>
      <div
        className="vrs_map"
        style={{ backgroundColor: "#168ACE", textAlign: "center" }}
      >
        <div
          className="txt-vrs"
          style={{ color: "white", paddingTop: "2px", marginLeft: "5px" }}
        >
          {locationName}
        </div>
      </div>
      ...
      <div className="container">
        ...
        <div className="row justify-content-md-center">
          <div className="col col-md-6">
            ...
            <button
              type="submit"
              className="btn btn-primary btn-block btn-access-public"
