...
const PublicServiceEmergency = () => {
  ...
  const [typeEmergency] = useState(localStorage.getItem("typeEmergency") === null ? "1" : localStorage.getItem("typeEmergency"));
          ...
          <div className="col col-md-6">
            <div>
              ...
              <div className="form-group">
                ...
                <input type="text" className="form-control" id="fieldPhone" onChange={handlePhone} value={phone} placeholder="กรอกเลขหมายโทรศัพท์" />
              </div>
              <div className="form-group">
                <label htmlFor="fieldPhone" className="public-label">
                  หน่วยงาน
