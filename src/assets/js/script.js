jQuery(document).ready(function ($) {
  ...
  */
    ...
    function responsiveChat(element) {
        $(element).html(
            '<form class="chat"><span></span><div class="show_date_history">วันที่ 01/01/2019</div><div class="messages"></div><div class="sec-send-message"><a href="javascript:history.back()" class="btn-backpage">ย้อนกลับ</a><a href="#" class="btn-no-message"></a><input type="text" placeholder="Message"><input type="submit" value="ส่ง"></form></div>'
        );
        ...
        $(element + ' input[type="submit"]').click(function (event) {
            ...
            if ($(element + ' input[type="text"]').val()) {
                ...
                $(element + " div.messages").append(
                    '<div class="message"><div class="myMessage"><p>' + message + "</p><date>" + currentDate + "</date></div></div>"
                );
                setTimeout(function () {
    ...
    function responsiveChatPush(element, sender, origin, date, message) {
        ...
        $(element + " .messages").append(
            '<div class="message"><div class="' + originClass + '"><p>' + message + "</p><date><b>" + sender + "</b> " + date + "</date></div></div>"
        );
    }
